            ...
            {{Form::open(array('url'=>'member','method'=>'post','class'=>'form-horizontal'))}}
                ...
                <div class="form-group">
                    <div class="col-lg-offset-2 col-lg-10">
                        <div class="checkbox">
                            <label>
                                <input name="readme" value="1" type="checkbox" checked> Saya telah membaca dan menyetujui <a href="{{url('service')}}" target="_blank" ><b>Syarat dan Ketentuan</b></a> di {{ Theme::place('title') }}.
                            </label>
                        </div>
                    </div>
                </div>
